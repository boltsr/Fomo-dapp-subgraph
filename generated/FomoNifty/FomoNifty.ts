...
export class FomoNifty extends ethereum.SmartContract {
  static bind(address: Address): FomoNifty {
    return new FomoNifty("FomoNifty", address);
  }
  ...
  isApproved(_tokenId: BigInt, _operator: Address): boolean {
  ...
  mint(_beneficiary: Address, _tokenUri: string): BigInt {
  ...
  primarySalePrice(param0: BigInt): BigInt {
    let result = super.call(
      "primarySalePrice",
      "primarySalePrice(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_primarySalePrice(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "primarySalePrice",
      "primarySalePrice(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
